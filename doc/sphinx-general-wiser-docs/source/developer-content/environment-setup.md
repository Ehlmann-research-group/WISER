...
Once you have done the above steps and are in the appropriate conda environment, you can go into the `src` folder and enter the command `python -m wiser`. WISER should start running. If it is your first time doing the command after your computer has started it, it may take longer.
