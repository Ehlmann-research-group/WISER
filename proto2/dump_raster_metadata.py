...
def dump_raster_metadata(path):
    ...
    if geo_transform is not None:
        ...
        if geo_transform[2] == 0 and geo_transform[4] == 0:
            print(f'North-up image.  Pixel size is {geo_transform[1]} {lin_units} x {geo_transform[5]} {lin_units}.')
    ...
    for i in range(1, ds.RasterCount + 1):
        ...
        print(f'  DataType:  {b.DataType} (GDAL), {gdal_array.GDALTypeCodeToNumericTypeCode(b.DataType)} (NumPy)')
