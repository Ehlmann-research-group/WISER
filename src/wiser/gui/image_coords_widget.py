...
class ImageCoordsWidget(QDialog):
    ...
    def _set_all_visible(self, visible):
        for w in [
            self._ui.lbl_pixel,
            self._ui.lbl_pixel_coords,
            self._ui.lbl_geo,
            self._ui.lbl_geo_coords,
        ]:
    ...
    def _update_internal(self):
        ...
        has_ds_and_point = self._dataset is not None and self._pixel_coords is not None
    ...
    def _on_geo_dialog(self):
        ...
        visible_datasets: List[RasterDataSet] = (
