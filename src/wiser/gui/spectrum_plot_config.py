...
class SpectrumPlotConfigDialog(QDialog):
    ...
    def __init__(self, spectrum_plot, parent=None):
        ...
        self._init_tick_ui(
            spectrum_plot.get_x_major_tick_interval(),
            self._ui.ckbox_xaxis_major_ticks,
            self._ui.ledit_xaxis_major_ticks,
        )

        self._init_tick_ui(
            spectrum_plot.get_x_minor_tick_interval(),
        ...
        self._update_tick_results(
            self._ui.lbl_xaxis_tick_results,
            self._ui.ckbox_xaxis_major_ticks,
            self._ui.ledit_xaxis_major_ticks,
            self._ui.ckbox_xaxis_minor_ticks,
            self._ui.ledit_xaxis_minor_ticks,
        ...
        self._ui.ckbox_xaxis_major_ticks.clicked.connect(self._on_xaxis_major_ticks)
        ...
        self._init_tick_ui(
            spectrum_plot.get_y_major_tick_interval(),
            self._ui.ckbox_yaxis_major_ticks,
            self._ui.ledit_yaxis_major_ticks,
        )

        self._init_tick_ui(
            spectrum_plot.get_y_minor_tick_interval(),
        ...
        self._update_tick_results(
            self._ui.lbl_yaxis_tick_results,
            self._ui.ckbox_yaxis_major_ticks,
            self._ui.ledit_yaxis_major_ticks,
            self._ui.ckbox_yaxis_minor_ticks,
            self._ui.ledit_yaxis_minor_ticks,
        ...
        self._ui.ckbox_yaxis_major_ticks.clicked.connect(self._on_yaxis_major_ticks)
    ...
    def _update_tick_results(
        self,
        label: QLabel,
        ckbox_major: QCheckBox,
        ledit_major: QLineEdit,
        ckbox_minor: QCheckBox,
        ledit_minor: QLineEdit,
    ):
    ...
    def _describe_tick_results(
        self,
        major_enabled: bool,
        major_interval: Optional[float],
        minor_enabled: bool,
        minor_interval: Optional[float],
    ):
        result = []
    ...
    def accept(self):
        ...
        self._spectrum_plot.set_font_name(self._ui.cbox_font.currentFont().family())
        ...
        if manual_range:
            range = (
                float(self._ui.ledit_xaxis_minval.text().strip()),
        ...
        if manual_range:
            range = (
                float(self._ui.ledit_yaxis_minval.text().strip()),
