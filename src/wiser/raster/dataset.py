...
class RasterDataSet:
    ...
    def __init__(self, impl: RasterDataImpl, data_cache: DataCache = None):
        ...
        self._default_display_bands: Optional[DisplayBands] = (
    ...
    def copy_spatial_metadata(
        self, source: Union["RasterDataSet", "RasterDataBand"]
    ) -> None:
        """
    ...
    def copy_spectral_metadata(
        self, source: Union["RasterDataSet", "Spectrum"]
    ) -> None:
    ...
    def update_band_info(self, wavelengths: List[u.Quantity]):
        ...
        assert isinstance(wavelengths[0], u.Quantity), (
            "Wavelengths array passed into band info isn't made of u.Quantity"
        )
        assert len(wavelengths) == self.num_bands(), (
