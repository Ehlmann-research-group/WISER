...
class TestCRSCreator(unittest.TestCase):
    ...
    def test_saving_crs(self):
        ...
        self.full_run_through(projection_type=projection_type, shape_type=shape_type, semi_major_val=semi_major_val,
                                   axis_ingestion_type=axis_ingestion_type, axis_ingestion_value=axis_ingestion_value, prime_meridian=prime_meridian,
                                   center_longitude=center_longitude, latitude_choice=latitude_choice, latitude_value=latitude_value, name=name)
    ...
    def test_created_crs_in_georeferencer(self):
        ...
        """
        name = "test"
        self.full_run_through(projection_type=ProjectionTypes.EQUI_CYLINDRICAL, \
                            prime_meridian=0, \
                            center_longitude=0, \
        ...
        ground_truth_ds_path = os.path.join("..", "test_utils", "test_datasets", "caltech_4_100_150_nm_epsg4087.tif")
