...
class TestSimliarityTransformGUI(unittest.TestCase):
    ...
    def test_rotate_scale(self):
        ...
        ground_truth_path = os.path.join("..", "test_utils", "test_datasets", "caltech_4_100_150_nm_rot_35_scale_2_linear_gt")

        temp_save_path = os.path.join("..", "test_utils", "test_datasets", "generated", "caltech_4_100_150_nm_rot_35_scale_2_linear.tif")
