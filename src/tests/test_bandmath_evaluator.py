...
class TestBandmathEvaluator(unittest.TestCase):
    ...
    def test_bandmath_add_image_number(self):
        ...
        variables = {
            "image": (VariableType.IMAGE_CUBE, BasicValueSerialized(img)),
            "image2": (VariableType.IMAGE_CUBE, BasicValueSerialized(img)),
        }
...
#                         os.path.join(raster_batch_band.get_folderpath(), original_file_name)
#                     ),
#                     interactive=False,
#                 )[0]
...
if __name__ == "__main__":
    ...
    test_class.setUp()
    test_class.test_bandmath_add_image_number()
    test_class.tearDown()
