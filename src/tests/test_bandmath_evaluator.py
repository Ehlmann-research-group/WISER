...
class TestBandmathEvaluator(unittest.TestCase):
    ...
    def test_bandmath_numbers_only(self):
        ...
        (result_type, result_value) = bandmath.eval_bandmath_expr(
            "(2 * 3 + 4) / 2", expr_info, result_name, cache, {}, {}
        )
    ...
    def test_bandmath_add_image_band(self):
        ...
        (result_type, result_dataset) = bandmath.eval_bandmath_expr(
            "image + band",
            expr_info,
            result_name,
            cache,
    ...
    def test_bandmath_add_band_number(self):
        ...
        (result_type, result_band) = bandmath.eval_bandmath_expr(
            "b + 0.5",
            expr_info,
            result_name,
            cache,
    ...
    def test_bandmath_add_spectrum_number(self):
        ...
        (result_type, result_spectrum) = bandmath.eval_bandmath_expr(
            "S1 + 0.5",
            expr_info,
            result_name,
            cache,
